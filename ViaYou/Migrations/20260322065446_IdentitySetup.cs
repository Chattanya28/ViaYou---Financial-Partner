        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LogoUrl = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BankPolicies", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InterestRate = table.Column<decimal>(type: "TEXT", nullable: false),
                    AccountNumberMasked = table.Column<string>(type: "TEXT", maxLength: 20, nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "BankPolicies",
                columns: new[] { "Id", "BankName", "InterestRate", "LogoUrl", "MinimumAmount", "PolicyType", "TenureDays", "UpdatedAt" },
                values: new object[,]
                {
                    { 1, "AU Small Finance Bank", 7.5m, "/assets/banks/au.png", 1000m, "FD", 365, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 2, "Bandhan Bank", 7.3m, "/assets/banks/bandhan.png", 5000m, "FD", 365, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 3, "HDFC Bank", 7.0m, "/assets/banks/hdfc.png", 10000m, "FD", 365, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 4, "ICICI Bank", 6.9m, "/assets/banks/icici.png", 10000m, "FD", 365, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 5, "State Bank of India", 6.8m, "/assets/banks/sbi.png", 1000m, "FD", 365, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) }
                });
